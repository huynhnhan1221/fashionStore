...
%>
                        <tr><td><a href="productdetail.jsp?productid=<%=product.getId()%>">
                                <img src="images_data/<%=product.getImage() %>" width="150" height="100"/>
                        </a></td></tr>
                    <% } %>
                                    </table>
                                </div>
			...
			<div class="content-box">
             ...
             <form name="registerform" action="CustomerRegisterServlet" method="post">
                <table>
                    ...
                    <tr>
                        <td>Ngày Sinh: &nbsp;</td>
                        <td><input class="textfield" title="Nhập ngày tháng năm sinh" type="text" name="birthday" required="true" >&nbsp;dd/mm/yyyy</td>
                    </tr>
                    <tr>
                        <td>Email: &nbsp;</td>
                    ...
                    <tr>
                        <td><input class="btn_active" type="submit" name="register" value="Đăng ký"/></td>
